...
export default function MainHeader() {
  return (
    <header className="fixed right-0 z-30 flex items-center border-b sm:border-b-0 left-sidebar-width h-header-height bg-c-white dark:bg-c-dark-grey border-c-lines-light dark:border-c-lines-dark sm:left-14 sm:z-30">
